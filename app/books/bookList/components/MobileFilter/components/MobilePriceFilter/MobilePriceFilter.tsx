...
import { FilterTemplateContainer } from "../../../Filter/components/GenreFilter/GenreFilter.style";
import { MobilePriceSlider } from "./MobilePriceFilter.style";
import { IMobilePriceFilter } from "./MobilePriceFilter.types";

const MobilePriceFilter: React.FC<IMobilePriceFilter> = ({
  filter,
  priceChange,
}) => {
  ...
  return (
    <FilterTemplateContainer className="mb-4">
      <div className=" mb-2 p-3 pb-4">
        <div className="font-500 mb-3">{t("BOOKS.PRICE")}</div>
        <MobilePriceSlider
          value={value}
